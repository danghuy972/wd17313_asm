                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="{{ route('homepage') }}" class="nav-item nav-link">About</a>
                            <a href="{{ route('courses') }}" class="nav-item nav-link">Courses</a>
                            <a href="{{ route('homepage') }}" class="nav-item nav-link">Teachers</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Blog</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="{{ route('homepage') }}" class="dropdown-item">Blog List</a>
                                    <a href="{{ route('homepage') }}" class="dropdown-item">Blog Detail</a>
                                </div>
                            </div>
                        </div>
                        <ul class="navbar-nav ms-auto">
